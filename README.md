...
* [AM](https://github.com/ivan-hc/AM) `am -i rewaita` or `appman -i rewaita`

* [dbin](https://github.com/xplshn/dbin) `dbin install rewaita.appimage`

* [soar](https://github.com/pkgforge/soar) `soar install rewaita`
